...
This project is maintained by one person, and reports are handled through GitHub rather
than through a private mailing address.

Report unacceptable behaviour by contacting the maintainer,
[@mattagame](https://github.com/mattagame), directly on GitHub. If the report concerns
the maintainer, or you would rather it not go to them at all, use GitHub's own
[report abuse](https://github.com/contact/report-abuse) form, which reaches GitHub Support
